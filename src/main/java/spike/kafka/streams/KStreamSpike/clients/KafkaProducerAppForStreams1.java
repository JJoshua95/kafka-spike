...
public class KafkaProducerAppForStreams1 {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            for (int i = 0; i < 10; i++) {
                if (i % 2 == 0) {
                    // send messages with even keys to first streams-input topic
                    myProducer.send(new ProducerRecord<String, String>("streams-input",
                            Integer.toString(i), "MyMessage: " + Integer.toString(i)));
                } else {
                    // send messages with odd keys to second streams-input topic
